...
from webApp.models import Spot, SectorSpot, ParkingLot, Sector, ImageCoordinates
from imageInput.models import Image

# Non persistant class
# processor not an object
